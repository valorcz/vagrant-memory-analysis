...
<template>
  <SlideFrame mode="topic">
    <div ref="outer" class="two-cols-fit w-full h-full flex flex-col justify-start">
      <div ref="inner" class="two-cols-inner w-full origin-top" :style="{ transform: scale < 1 ? `scale(${scale})` : undefined }">
        <div class="two-cols" :class="fm.colsClass">
          <div class="col"><slot /><slot name="left" /></div>
